...
public class HuffmanCoding {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            writeBinaryFile(compressedFilePath, compressed);

            String decompressed = decode(root, readBinaryFile(compressedFilePath));
    ...
    private static void writeBinaryFile(String filePath, String binaryData) throws IOException {
    ...
    private static String readBinaryFile(String filePath) throws IOException {
